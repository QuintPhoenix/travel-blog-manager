...
export const BlogForm = () => {
  ...
  async function generateBlogSection(i: number) {
    ...
    const response = await fetch(`https://tbm-api.koyeb.app/${section.model}`, {
      method: "POST",
      body: JSON.stringify({
        title: input.title,
  ...
  async function generateImages() {
    const response = await fetch(`https://tbm-api.koyeb.app/images/pexels?location=${encodeURIComponent(input.title)}`);
